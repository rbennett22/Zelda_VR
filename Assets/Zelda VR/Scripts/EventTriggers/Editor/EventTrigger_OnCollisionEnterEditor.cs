...
[CustomEditor(typeof(EventTrigger_OnCollisionEnter), false)]

public class EventTrigger_OnCollisionEnterEditor : Editor
{
    const string DELEGATES_PROPERTY_NAME = "_delegates";
    const string EVENT_NAME = "OnCollisionEnter";
