...
public class DungeonRoom : MonoBehaviour 
{
    ...
    public void ActivateTorchLights(bool doActivate = true)
    {
        ...
        if (!IsNpcRoom)
        {
            ...
            if (doActivate)
            {
                DungeonFactory.Instance.AssignWallMaterials(this);
            }
        }
    }
    ...
    public void SetWallTypeForDirection(DungeonRoomInfo.WallDirection direction, DungeonRoomInfo.WallType type)
    {
        ...
        wall.GetComponent<Renderer>().material = DungeonFactory.Instance.GetWallMaterial(direction, type);
    ...
    public static DungeonRoom GetRoomForPosition(Vector3 position)
    {
        ...
        return DungeonFactory.Instance.GetRoomAtGridPosition(x, z);
    }
