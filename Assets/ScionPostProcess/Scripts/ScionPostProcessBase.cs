...
namespace ScionEngine
{
	...
	{					
		...
		[Inspector.Slider("Intensity", useProperty = "grainIntensity", visibleCheck = "ShowGrain", minValue = 0.0f, maxValue = 0.4f, tooltip = "How strong the grain effect is")]
		...
		[SerializeField] protected float m_chromaticAberrationDistortion = 0.7f;
		[Inspector.Slider("Intensity", useProperty = "chromaticAberrationIntensity", visibleCheck = "ShowChromaticAberration", minValue = 0.0f, maxValue = 20.0f, tooltip = "How strong the distortion effect is")]
		...
		[Inspector.Slider("Brightness", useProperty = "bloomBrightness", visibleCheck = "ShowBloom", minValue = 1.0f, maxValue = 8.0f, tooltip = "How bright the bloom effect is")]
		...
		protected bool ShowBlurStrength() { return ShowLensFlare() && m_lensFlareBlurSamples != LensFlareBlurSamples.Off; }
		...
		[Inspector.Slider("Blur Strength", useProperty = "lensFlareBlurStrength", visibleCheck = "ShowBlurStrength", minValue = 0.0f, maxValue = 1.0f, tooltip = "How spread out the blur samples are")]
		...
		[SerializeField] protected Texture m_lensDirtTexture = null;
		...
		[Inspector.Slider("Bloom Brightness", useProperty = "lensDirtBloomBrightness", visibleCheck = "ShowLensDirtSettings", minValue = 0.5f, maxValue = 8.0f, tooltip = "How bright the lens dirt effect is")]
		...
		protected bool ShowFNumber() { return ShowCameraMode() == false || (cameraMode == CameraMode.AperturePriority || cameraMode == CameraMode.Manual || (cameraMode == CameraMode.Off && depthOfField == true)); }
		...
		[Inspector.Slider("F Number", useProperty = "fNumber", visibleCheck = "ShowFNumber", minValue = 1.4f, maxValue = 22.0f, tooltip = "The F number of the camera")]
		...
		protected bool ShowTargetTransform() { return m_depthFocusMode == DepthFocusMode.TargetTransform && ShowDepthOfField(); }
		protected bool ShowFocalRange() { return m_depthFocusMode == DepthFocusMode.ManualRange && ShowDepthOfField(); }
		protected bool ShowTemporalSettings() { return m_depthOfFieldTemporalSupersampling == true && ShowDepthOfField(); }
		...
		[SerializeField] protected float m_maxCoCRadius = 20.0f;		
		[Inspector.Toggle("Temporal Supersampling", useProperty = "depthOfFieldTemporalSupersampling", visibleCheck = "ShowDepthOfField", tooltip = "If active the Depth of Field will be temporally supersampled. This improves quality but can cause an unsharp result")]
		[SerializeField] protected bool m_depthOfFieldTemporalSupersampling = true;	
		[Inspector.Slider("Temporal Blend", useProperty = "depthOfFieldTemporalBlend", visibleCheck = "ShowTemporalSettings", minValue = 0.8f, maxValue = 0.95f, tooltip = "How much of the final result is influenced by the temporal supersampling")]
		[SerializeField] protected float m_depthOfFieldTemporalBlend = 0.9f;
		[Inspector.Slider("Temporal Steps", useProperty = "depthOfFieldTemporalSteps", visibleCheck = "ShowTemporalSettings", minValue = 4.0f, maxValue = 10.0f, tooltip = "How many different sample offsets the temporal supersampling uses before looping around")]
		[SerializeField] protected int m_depthOfFieldTemporalSteps = 8;
		[Inspector.Field("Sample Count", useProperty = "depthOfFieldSamples", visibleCheck = "ShowDepthOfField", tooltip = "How many samples the algorithm does")]
		[SerializeField] protected DepthOfFieldSamples m_depthOfFieldSamples = DepthOfFieldSamples.Normal_25	;
		...
		[Inspector.Toggle("Visualize Focal Distance", useProperty = "visualizeFocalDistance", visibleCheck = "ShowDepthOfField", tooltip = "Visualizes the areas that are in and out of focus")]
		[SerializeField] protected bool m_visualizeFocalDistance = false;
		[Inspector.Field("Target Transform", useProperty = "depthOfFieldTargetTransform", visibleCheck = "ShowTargetTransform", tooltip = "Will autofocus on the depth from this camera to the target transform")]
		[SerializeField] protected Transform m_depthOfFieldTargetTransform = null;
		...
		[Inspector.Slider("Point Range", useProperty = "pointAverageRange", visibleCheck = "ShowPointAverage", minValue = 0.01f, maxValue = 0.2f, tooltip = "How far the point average calculation reaches")]
		[SerializeField] protected float m_pointAverageRange = 0.1f;
		[Inspector.Toggle("Visualize Point Focus", useProperty = "visualizePointFocus", visibleCheck = "ShowPointAverage", tooltip = "Show the area of influence on the main screen for visualizaiton")]
		...
		public DepthFocusMode depthFocusMode 
		{
			...
			set 
			{ 
				m_depthFocusMode = value; 
				postProcessParams.DoFParams.depthFocusMode = value; 

				//TargetTransform mode manipulates the internal focal depth, so force a reset when depthFocusMode changes
				focalDistance = focalDistance;
			}
		}
		public bool visualizeFocalDistance
		{
			get { return m_visualizeFocalDistance; }
			set { m_visualizeFocalDistance = value; postProcessParams.DoFParams.visualizeFocalDistance = value; }
		}
		public Transform depthOfFieldTargetTransform
		{
			get { return m_depthOfFieldTargetTransform; }
			set { m_depthOfFieldTargetTransform = value; }
		}
		...
		{
			get { return m_depthOfFieldTemporalSupersampling; }
			set { m_depthOfFieldTemporalSupersampling = value; postProcessParams.DoFParams.useTemporal = value; }
		}
		public float depthOfFieldTemporalBlend 
		{
			get { return m_depthOfFieldTemporalBlend; }
			set { m_depthOfFieldTemporalBlend = value; postProcessParams.DoFParams.temporalBlend = value; }
		}
		public int depthOfFieldTemporalSteps 
		{
			get { return m_depthOfFieldTemporalSteps; }
			set { m_depthOfFieldTemporalSteps = value; postProcessParams.DoFParams.temporalSteps	 = value; }
		}

		public DepthOfFieldSamples depthOfFieldSamples 
		{
			get { return m_depthOfFieldSamples; }
			set { m_depthOfFieldSamples = value; postProcessParams.DoFParams.quality = value; }
		}
...
//			    camera.hdr == false && QualitySettings.antiAliasing > 0) forwardMSAAFix = 1.0f;
		...
		{			
			postProcessParams.cameraParams.previousViewProjection = camera.projectionMatrix * camera.worldToCameraMatrix;
		}
