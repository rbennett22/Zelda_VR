...
#define CoCToPixels 			_VirtualCameraParams2.w
...
float2 ComputeCoCScaleAndBiasFromAperture(float apertureDiameter, float focalLength, float focalDistance, float CoCToPixelsMult)
{
	...
	return float2(CoCScale, CoCBias) * CoCToPixelsMult;
}

float2 ComputeCoCScaleAndBias(float fNumber, float focalLength, float focalDistance, float CoCToPixelsMult)
{
	float apertureDiameter = ComputeApertureDiameter(fNumber, focalLength);
	return ComputeCoCScaleAndBiasFromAperture(apertureDiameter, focalLength, focalDistance, CoCToPixelsMult);
}
